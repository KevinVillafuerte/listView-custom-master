...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tema1 = Producto("Manejo de ListView",R.drawable.activity,"Un ListView es un componente de vista de lista que nos servirá para mostrar datos, tal como puede ser una lista de contactos, lista de productos, etc.",R.drawable.cd1)
        ...
        val tema2 = Producto("Manejo de Activities",R.drawable.activity,"Una Activity es un componente de la aplicación que contiene una pantalla con la que los usuarios pueden interactuar para realizar una acción, como marcar" +
                " un número telefónico, tomar una foto, enviar un correo electrónico o ver un mapa. A cada actividad se le asigna una ventana en la que se puede dibujar su interfaz de usuario.",R.drawable.cd2 )
